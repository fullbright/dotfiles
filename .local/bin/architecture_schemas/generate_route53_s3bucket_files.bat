...
c:\myAPPS\dotfiles\.local\bin\architecture_schemas\.venv\Scripts\python c:\myAPPS\dotfiles\.local\bin\architecture_schemas\route53_s3bucket_data_analysis.py ^
